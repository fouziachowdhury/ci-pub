...
//            }
           ...
           $hasper = $checkpermission->trial;
            if ($checkpermission->active == 1 || $checkpermission->trial == 1) {
                ...
                $data['allfbadds'] = $this->FacebookaddsModel->getloadfbadds($column_name,$config["per_page"], $data['page']);
                //echo '<pre>'; print_r($data['allfbadds']);
                $data['favbanner'] = $this->FacebookaddsModel->getfavaddsinfo($member_id);
              //print_r($data['favbanner']);
...
//        echo $totalRec;die;
        ...
        $column_name = "id";
        //get posts data
        $data['allfbadds'] = $this->FacebookaddsModel->getloadfbadds($column_name,$config["per_page"], $offset);
