            ...
            if (isset($checkpermission)) {
               ...
               // $hasper = $haspermission[0]['is_active'];
                ...
                //call the model function to get the department data
                    $data['alllandingpageinfo'] = $this->LandingModel->alllandingpage($config["per_page"], $data['page']);
...
//        echo $totalRec;die;
        ...
        //get posts data
        $data['alllandingpageinfo'] = $this->LandingModel->alllandingpage($config["per_page"], $offset);
