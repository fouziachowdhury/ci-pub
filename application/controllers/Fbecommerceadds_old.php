        ...
        if ($_SESSION['member_id'] != '') {
           ...
           // $permission_option_id = explode(',', $checkpermission->option_id);
            ...
            if ($hasper == 1) {
                ...
                $data['allfbeco'] = $this->FbecommerceaddsModel->getloadfbecom($config["per_page"], $data['page']);
...
//        echo $totalRec;die;
        ...
        //get posts data
        $data['allfbeco'] = $this->FbecommerceaddsModel->getloadfbecom($config["per_page"], $offset);
