...
class FacebookaddsModel extends CI_Model {
    ...
    public function getloadfbadds($limit, $start) { 
        $this->db->select('*');
        $this->db->from('facebook_ads');
    ...
    public function searchbannerpageinfobycountryid($country_id){
     ...
     public function searchfbpageinfobymyfav($member_id, $option_id){
         $this->db->select('*');
        $this->db->from('facebook_ads');
    ...
    public function searchfbpageinfobymycom($member_id, $option_id){
        $this->db->select('*');
        $this->db->from('facebook_ads');
