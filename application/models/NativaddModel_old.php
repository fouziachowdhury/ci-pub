...
class NativaddModel extends CI_Model {
    ...
    public function count_all_nativ(){
         $this->db->select('*');
        $this->db->from('native_ads');
        $query = $this->db->get();
        return $query->num_rows();
    }
    public function getAllnativadds($limit, $start) {
        $this->db->select('*');
        $this->db->from('native_ads');
    ...
    public function searchnativpageinfobymyfav($member_id, $option_id){
        $this->db->select('*');
        $this->db->from('native_ads');
    ...
    public function searchnativpageinfobymycom($member_id, $option_id){
        $this->db->select('*');
        $this->db->from('native_ads');
