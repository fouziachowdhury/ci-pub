                        ...
                        <table class="table table-bordered" id="tableName">
                            ...
                            <tr>
                                <td colspan="6" style="padding: 0px;">
                                    <form action="" id="form_data<?php echo $row[0]['fb_ecom_images_id']; ?>">
                                        <table class="table table-bordered" style="padding: 0px;">
                                            <tr style="text-align: center" id="row_data<?php echo $row[0]['fb_ecom_images_id']; ?>">
                                                ...
                                                <td style="width: 20%;padding: 10px 6px;">
                                                    <p style="display: block;" id="cat_text<?php echo $row[0]['fb_ecom_images_id']; ?>">
                                                        <?php
                                                    ...
                                                    <select class="select2 m-b-10 select2-multiple" id="category<?php echo $row[0]['fb_ecom_images_id']; ?>" multiple="multiple" name="category[]" style="display: none;">
                                                ...
                                                <td style="width: 20%;padding: 10px 6px;">
                                                    <p style="display: block;" id="country_text<?php echo $row[0]['fb_ecom_images_id']; ?>">
                                                        <?php
...
//                                    print_r($category);
                                                    ...
                                                    <select class="select2 m-b-10 select2-multiple" id="country<?php echo $row[0]['fb_ecom_images_id']; ?>" multiple="multiple" name="country[]" style="display: none;">
                                                ...
                                                <td style="width: 20%;padding: 10px 6px;">
                                                    <p style="display: block;" id="keyword_text<?php echo $row[0]['fb_ecom_images_id']; ?>">
                                                        <?php
                                                    ...
                                                    <input type="text" name="keyword" id="key<?php echo $row[0]['fb_ecom_images_id']; ?>" multiple class="" style="display: none;"
                                                           value="<?php
                                                           $keyword = explode(',', $row[0]['keyword']);
                                                           foreach ($all_keyword as $all_key) {
                                                               foreach ($keyword as $key) {
                                                ...
                                                <td style="width: 20%;padding: 10px 6px;">
                                                    <p style="display: block;" id="type_text<?php echo $row[0]['fb_ecom_images_id']; ?>">
                                                        <?php
                                                    ...
                                                    <div id="fb_type<?php echo $row[0]['fb_ecom_images_id']; ?>" style="display: none;">
                                                ...
                                                <td style="width: 10%;padding: 10px 6px;">
                                                    <a style="cursor: pointer;display: none;" id="update_button<?php echo $row[0]['fb_ecom_images_id']; ?>" onclick="updateFbImages(<?php echo $row[0]['fb_ecom_images_id']; ?>)">
                                                        Update
                                                    </a>
                                                    <a onclick="editInfo(<?php echo $row[0]['fb_ecom_images_id']; ?>)" id="edit_button<?php echo $row[0]['fb_ecom_images_id']; ?>" style="cursor: pointer;display: block;">Edit</a>
...
<!--                            <tr>
                        ...
                        <form action="admin/updateFbEcomLogo" method="post" enctype="multipart/form-data">
                            
                            <input type="hidden" name="id" class="form-control" value="<?php echo $all_facebook[0][0]['fb_ecom_id']; ?>">
...
<script>
    function editInfo(fb_ecom_images_id){
//        alert(fb_ecom_images_id);
        document.getElementById("category"+fb_ecom_images_id).style.display = "block";
        document.getElementById("country"+fb_ecom_images_id).style.display = "block";
        document.getElementById("key"+fb_ecom_images_id).style.display = "block";
        document.getElementById("update_button"+fb_ecom_images_id).style.display = "block";
        document.getElementById("fb_type"+fb_ecom_images_id).style.display = "block";
        
        document.getElementById("edit_button"+fb_ecom_images_id).style.display = "none";
        document.getElementById("country_text"+fb_ecom_images_id).style.display = "none";
        document.getElementById("cat_text"+fb_ecom_images_id).style.display = "none";
        document.getElementById("keyword_text"+fb_ecom_images_id).style.display = "none";
        document.getElementById("type_text"+fb_ecom_images_id).style.display = "none";
        
        $("#category"+fb_ecom_images_id).select2();
        $("#country"+fb_ecom_images_id).select2();
        $('#key'+fb_ecom_images_id).select2({
...
<script>
    function updateFbImages(fb_ecom_images_id){
        var str = $('#form_data'+fb_ecom_images_id).serialize();;
//        alert(str);
//        console.log(str);
        $.ajax({
            url: "<?php echo site_url('admin/updateFbEcomImages'); ?>",
            type: "post",
            data: {str: str,fb_ecom_images_id: fb_ecom_images_id},
            success: function (msg) {
//                alert("" + msg);
