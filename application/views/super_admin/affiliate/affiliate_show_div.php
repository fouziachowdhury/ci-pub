<form action="admin/editMultipleAffiliate" method="post">
    ...
    <table id="myTable" class="table table-striped">
        ...
        <!--<p style="text-align: right;color: red;">Search By Name, Email, Fee Paid</p>-->
            <tr>
                ...
                <th style="text-align: center;">Show Preview</th>
        ...
        <tbody>
            <?php $i = 1;
            foreach ($all_info as $landing) { //echo '<pre>'; print_r($landing); 
                ?>
                <tr style="text-align: center;">
                    <td>
                        <input class="check_id" name="id[]" type="checkbox" value="<?php echo $landing['id']; ?>" onclick="showButton()">
                    </td>
                    <!--<td><?php echo $i; ?></td>-->
                    <td>
                        <a class="example-image-link" href="<?php echo $landing['zip_file_name']; ?>" data-lightbox="example-1">
                            <img src="<?php echo $landing['zip_file_name']; ?>" alt="Banner Image" style="width: 100px;">
                        </a>
                    </td>
...
//                                    print_r($category);
                    ...
                    <td>
                        <a href="admin/editAffiliateLanding/<?php echo $landing['id']; ?>">
                            <span data-toggle="tooltip" data-placement="top" title="Edit" class="glyphicon glyphicon-edit"></span>
                        </a>&nbsp;
                        <a href="admin/delete_affiliate_landing/<?php echo $landing['id']; ?>" onclick="return chkDelete()">
