        ...
        <div class="white-box">
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                    ...
                    <!-------------MODEL END -------------->
                    <form action="admin/saveAffiliateLanding" method="post" enctype="multipart/form-data" id="landinfpageform">
...
//            alert(55555);
   ...
   <?php } ?>
    ...
    $('#btncancle').click(function () {
        window.location.href = "<?php echo base_url() ?>admin/allAffiliateLandingPages";
    });
...
//        alert(formdata);
        ...
        $.ajax({
            ...
            url: '<?php echo base_url() ?>admin/addAffiliateLanding',
