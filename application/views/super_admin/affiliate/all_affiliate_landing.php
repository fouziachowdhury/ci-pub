<div class="row">
    <div class="col-sm-12">
        <div class="white-box">
            <h3 class="" style="text-align: center;">All Affiliate Landing Pages</h3>
            <ul class="list-unstyled list-inline" style="text-align: right;">
                ...
                <div class="table-responsive">
                    <div id="showallbannerdiv">
                        <?php $this->load->view('super_admin/affiliate/affiliate_show_div'); ?>
                    </div>
                </div>
...
//        alert(country_id);
        ...
        var link = 'super_admin/affiliate/affiliate_show_div';
        var option_id = 6;
        $.ajax({
