...
<!--                    <h5 style="color: red;"><?php if (validation_errors()) {
                    ...
                    <form action="admin/saveWhoIsSetting" method="post" enctype="multipart/form-data">
                        
                        <div class="form-group">
                            <input type="hidden" name="option_id[]" value="8">
                            <label for="exampleInputuname">Whois Silver Price</label>
                            <input type="text" name="option_price[]" class="form-control" value="<?php echo $all_info[7]['option_price']?>" placeholder="Whois Silver Price">
                        </div> 
                        
                        <div class="form-group">
                            <input type="hidden" name="option_id[]" value="9">
                            <label for="exampleInputuname">Whois Gold Price</label>
                            <input type="text" name="option_price[]" class="form-control" value="<?php echo $all_info[8]['option_price']?>" placeholder="Whois Gold Price">
                        </div>
                        
                        <div class="form-group">
                            <input type="hidden" name="option_id[]" value="10">
                            <label for="exampleInputuname">Whois Platinum Price</label>
                            <input type="text" name="option_price[]" class="form-control" value="<?php echo $all_info[9]['option_price']?>" placeholder="Whois Platinum Price">
                        </div>
