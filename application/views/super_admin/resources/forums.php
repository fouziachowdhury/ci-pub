                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">Add Forums</h4>
                        </div>
                        <form action="admin/save_forums" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                    ...
                    ?>
                       ...
                       <?php } ?>
                    <h3 class="" style="text-align: center;">All Forums</h3>
                                ...
                                foreach ($resource_data as $row) { ?>
                                    <tr style="text-align: center;">
                                        ...
                                        <td>
                                            ...
                                            <a href="admin/deleteForums/<?php echo $row['id']; ?>" onclick="return chkDelete()">
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <h4 class="modal-title" style="text-align: center">Edit Forums</h4>
                                                    </div>
                                                    <form action="admin/update_forums" method="post" enctype="multipart/form-data">
