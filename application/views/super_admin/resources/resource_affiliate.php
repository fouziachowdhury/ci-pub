                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">Add Affiliate Networks</h4>
                        </div>
                        <form action="resourceAdmin/save_affiliate_network" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                    ...
                    ?>
                       ...
                       <?php } ?>
                    <h3 class="" style="text-align: center;">All Affiliate Networks</h3>
                            ...
                            <tbody>
                                ...
                                foreach ($resource_data as $row) { ?>
                                    <tr style="text-align: center;">
                                        ...
                                        <td>
                                            <a data-toggle="modal" data-target="#editLink<?php echo $row['resource_id']; ?>" style="cursor: pointer;">
                                                <span data-toggle="tooltip" data-placement="top" title="Edit Category" class="glyphicon glyphicon-edit"></span>
                                            </a>&nbsp;
                                            <a href="resourceAdmin/deleteAffiliateNetwork/<?php echo $row['resource_id']; ?>" onclick="return chkDelete()">
                                                <span data-toggle="tooltip" data-placement="top" title="Remove" class="glyphicon glyphicon-remove"></span>
                                            </a>
                                        </td>
                                        
                                        
                                        <div id="editLink<?php echo $row['resource_id']; ?>" class="modal fade" role="dialog">
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <h4 class="modal-title" style="text-align: center">Edit Affiliate Networks</h4>
                                                    </div>
                                                    <form action="resourceAdmin/update_affiliate_network" method="post" enctype="multipart/form-data">
                                                        <input type="hidden" name="id" class="form-control" value="<?php echo $row['resource_id'] ?>">
...
<script>
    ...
    function getTitle(val){
        $.ajax({
            url: "<?php echo site_url('resourceAdmin/get_title'); ?>",
            type: "post",
            data: {url: val},
...
//        });
    ...
    function getUrl(val){
        $.ajax({
            url: "<?php echo site_url('resourceAdmin/get_url'); ?>",
            type: "post",
            data: {url: val},
            success: function (msg) {
//                alert("" + msg);
