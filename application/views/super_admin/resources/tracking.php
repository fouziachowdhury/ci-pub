            ...
            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="admin/save_tracking" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                    ...
                    ?>
                       ...
                       <?php } ?>
                    <h3 class="" style="text-align: center;">All Tracking</h3>
                                ...
                                foreach ($resource_data as $row) { ?>
                                    <tr style="text-align: center;">
                                        ...
                                        <td>
                                            ...
                                            <a href="admin/deleteTracking/<?php echo $row['id']; ?>" onclick="return chkDelete()">
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <h4 class="modal-title" style="text-align: center">Edit Tracking</h4>
                                                    </div>
                                                    <form action="admin/update_tracking" method="post" enctype="multipart/form-data">
