                ...
                <div class="col-sm-12 col-xs-12">
                    <h5 style="color: red;"><?php
                     ...
                     <?php if ($this->session->flashdata('success')) { ?>
                       ...
                       <?php } ?>
                    <form action="WhoisAdmin/updateFreeWhois" method="post" enctype="multipart/form-data">
                        <div class="col-xs-12">
                            <div class="form-group col-xs-12">
                                <label for="exampleInputuname">Monthly Membership Price</label>
                                <input type="text" name="mothly_membership_price" class="form-control" readonly="" value="0">
                            </div>
                        </div>
