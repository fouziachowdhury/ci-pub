<div class="row">
    <div class="col-sm-12">
        <div class="white-box">
            <h3 class="" style="text-align: center;">All Landing Pages</h3>
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-design" style="height: 350px;overflow: auto;">
                                <?php foreach ($all_country as $country) { ?>
                                    <li value="<?php echo $country['country_id']; ?>">
                                        <a onclick="searchbycountry(<?php echo $country['country_id']; ?>)"><?php echo $country['country_name']; ?></a>
                                    </li>
                                <?php } ?>
                            </ul>
                        </div>
                ...
                <div id="showallbannerdiv">
                    <?php $this->load->view('super_admin/landing/landing_show_div'); ?>
                </div>
            </div>
...
//        alert(country_id);
        ...
        var link = 'super_admin/landing/landing_show_div';
        var option_id = 13;
        $.ajax({
            url: "<?php echo site_url('landingpageadmin/searchbycountry'); ?>",
            type: "post",
    ...
    function searchbycategory(cat_id) {
        ...
        $.ajax({
            url: "<?php echo site_url('landingpageadmin/searchbycategory'); ?>",
            type: "post",
