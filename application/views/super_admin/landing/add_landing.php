        ...
        <div class="white-box">
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                    ...
                    <!-------------MODEL END -------------->
                    <form action="landingPageAdmin/insertlandingpage" method="post" enctype="multipart/form-data" id="landinfpageform">
...
//        alert(val);
        $.ajax({
            url: "<?php echo site_url('landingPageAdmin/check_url'); ?>",
            type: "post",
            data: {url: val},
...
//            alert(55555);
   ...
   <?php } ?>
    ...
    $('#btncancle').click(function () {
        window.location.href = "<?php echo base_url() ?>landingPageAdmin/allLandingPages";
    });
...
//        alert(formdata);
        ...
        $.ajax({
            ...
            url: '<?php echo base_url() ?>landingPageAdmin/insertlandingpagewithcheckurl',
