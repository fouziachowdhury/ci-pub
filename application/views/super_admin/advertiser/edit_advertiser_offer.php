            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                  <h5 style="color: red;"><?php if (validation_errors()) {
                    ...
                    <form action="admin/updateAdvertiserOffer/<?php echo $this->uri->segment('3');?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="exampleInputuname">URL</label>
                            <textarea class="form-control" onkeyup="checkUrl(this.value)" name="url" style="resize: none;"><?php echo $edit_landing_info[0]['url']; ?></textarea>
                        </div>
