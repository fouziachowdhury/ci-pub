...
<!--                    <h5 style="color: red;"><?php if (validation_errors()) {
                    ...
                    <form action="admin/saveAdvertiserOfferSettings" method="post" enctype="multipart/form-data">
                        
                        <div class="form-group">
                            <label for="exampleInputuname">Monthly Membership Price</label>
                            <input type="text" name="membership_price" class="form-control" value="<?php if($advertiser_settings){echo $advertiser_settings[0]['membership_price'];}?>" placeholder="Monthly Membership Price">
                        </div> 
                        
                        <div class="form-group">
                            <label for="exampleInputuname">View Page Count</label>
                            <input type="text" name="view_count" class="form-control" value="<?php if($advertiser_settings){echo $advertiser_settings[0]['view_count'];}?>" placeholder="Count View Page">
                        </div>
                        
                        <div class="form-group">
                            <label for="exampleInputuname">Domain Tools limit</label>
                            <input type="text" name="download_count" class="form-control" value="<?php if($advertiser_settings){echo $advertiser_settings[0]['download_count'];}?>" placeholder="Count Download">
                        </div>
