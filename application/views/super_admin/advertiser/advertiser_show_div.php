<form action="admin/editMultipleAdvertiser" method="post">
...
//                                    print_r($category);
                    ...
                    <td>
                        <a href="admin/editAdvertiserOffer/<?php echo $landing['id']; ?>">
                            <span data-toggle="tooltip" data-placement="top" title="Edit" class="glyphicon glyphicon-edit"></span>
                        </a>&nbsp;
                        <a href="admin/delete_advertiser_offer/<?php echo $landing['id']; ?>" onclick="return chkDelete()">
