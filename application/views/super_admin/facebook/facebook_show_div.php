        ...
        foreach (array_chunk($all_info, 2) as $row) {
            ...
            <tr>
                ...
                <?php foreach ($row as $value) { ?>
                    <td colspan="1">
                        <form  action="admin/activatePreview" method="post" enctype="multipart/form-data">
                            <table>
                                <tr>
                                    ...
                                    <td><?php //echo $value['id']; ?>
                                        ...
                                        <?php } ?>
                                        <input type="hidden" name="facebook_ads_id" value="<?php echo $value['id']; ?>">
                                        ...
                                        <a data-toggle="modal" data-target="#editLink<?php echo $value['id']; ?>" style="cursor: pointer;">
                                            <button class="btn btn-info">Edit</button>
                                        </a>
                                        <a href="admin/deleteFacebookImage/<?php echo $value['id']; ?>">
                        ...
                        <div id="editLink<?php echo $value['id']; ?>" class="modal fade" role="dialog">
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="admin/updateFacebook" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="bulk_keyword[]" class="keyword" id="keyword_bulk<?php echo $value['id']; ?>" multiple class="" 
                                                           value="<?php
