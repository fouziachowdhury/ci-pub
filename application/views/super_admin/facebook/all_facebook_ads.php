...
<script>
    ...
    function searchbycountry(country_id) {
        var table = 'facebook_ads';
        var link = 'super_admin/facebook/facebook_show_div';
        var option_id = 3;
        $.ajax({
            url: "<?php echo site_url('admin/search_by_fb_country'); ?>",
            type: "post",
    ...
    function searchbycategory(cat_id) {
        ...
        var link = 'super_admin/facebook/facebook_show_div';
        var option_id = 3;
        var page_link = 'admin/allFacebook';
        var country_id = document.getElementById('country_id').value;
        
        $.ajax({
            url: "<?php echo site_url('admin/search_fb_by_category'); ?>",
            type: "post",
            data: {cat_id: cat_id,table: table,link:link,option_id:option_id,page_link:page_link,country_id:country_id},
            success: function (result) {
               // alert(result);
                var hhh = JSON.parse(result);
                console.log(hhh);
