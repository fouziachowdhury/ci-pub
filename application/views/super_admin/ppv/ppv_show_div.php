<form action="admin/editMultiplePpv" method="post">
        ...
        <tbody>
            ...
            foreach ($all_info as $landing) { //echo '<pre>'; print_r($landing); 
                ...
                <tr style="text-align: center;">
                    <!--<td><?php echo $i; ?></td>-->
                    <td>
                        <input class="check_id" name="ppv_id[]" type="checkbox" value="<?php echo $landing['ppv_id']; ?>" onclick="showButton()">
                    </td>
                    <td>
...
//                                    print_r($category);
                    ...
                    <td>
                        <a href="admin/editPpvAds/<?php echo $landing['ppv_id']; ?>">
                            <span data-toggle="tooltip" data-placement="top" title="Edit" class="glyphicon glyphicon-edit"></span>
                        </a>&nbsp;
                        <a href="admin/delete_ppv_ads/<?php echo $landing['ppv_id']; ?>" onclick="return chkDelete()">
