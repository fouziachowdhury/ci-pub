            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="">
                    ...
                    <div class="showbandiv" id="postList">
                        <?php $this->load->view('front/resource/affliateNetwork/affliNetShowDiv'); ?>
                    </div>
...
function searchFilter(page_num) {
    ...
    var table = 'resources_tbl';
    var page_link = 'front/resource/affliateNetwork/affliNetShowDiv';
...
<script>
    $(function () {
        $("#banTag").autocomplete({
            source: "<?php echo base_url() ?>resource/resourceTagAutocomplete",
