                        ...
                        foreach ($allresource as $affli) {
                            ...
                            <tr>
                                ...
                                <td style="font-size: 11px; padding: 15px;"> 
                                    ...
                                    <span onclick="showcommentbox('<?php echo $affli['resource_id']; ?>')" data-toggle="modal" data-target="#bannercommentmodal">
                                    ...
                                    <?php if (in_array($affli['resource_id'], $favresource)) { ?>
                                    ...
                                    <?php } else { ?>
                                        <span> <a href="<?php echo base_url() ?>makefavoritesresource/<?php echo $affli['resource_id']; ?>/20"><img data-toggle="tooltip" data-placement="bottom" title="Favorites" style="width: 16px; margin-left: 8px; margin-right: 8px;" src="<?php echo base_url() ?>assets/icon/favorites.png" style="color:red;width: 16px;">Add To Favorites </a></span>
                                    <?php } ?> 
                                    <span><a href="<?php echo $affli['url']; ?>" target="_blank"><img data-toggle="tooltip" data-placement="bottom" title="View" src="<?php echo base_url() ?>assets/icon/whois.png" style="color:#3079C8; width: 16px;">View </a></span></td>
