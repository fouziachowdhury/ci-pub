            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="">
                    ...
                    <div class="showbandiv" id="postList">
                        <?php $this->load->view('front/resource/coaching/coachingShowDiv'); ?>
                    </div>
...
function searchFilter(page_num) {
    ...
    var table = 'coaching';
    var page_link = 'front/resource/coaching/coachingShowDiv';
...
<script>
    $(function () {
        $("#banTag").autocomplete({
            source: "<?php echo base_url() ?>resource/coachingTagAutocomplete",
