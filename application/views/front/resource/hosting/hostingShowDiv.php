            ...
            <table class="table table-striped" style="border: 1px solid #ddd;background: #fff;">
                ...
                <tbody>
                    ...
                    if (!empty($allresource)) {
                        foreach ($allresource as $hosting) {
                            ?>
                            <tr>
                                <td> <a class="thumbnail" style="margin-top: 5px;margin-left: 5px; margin-bottom: 0px;"><img style="width: 110px;" class="img-responsive" src="<?php echo $hosting['zip_file_name']; ?>" alt=""></a></td>
                                <td style="font-size: 11px; padding: 15px;"><h5 style="font-weight: bold;"><?php echo $hosting['title']; ?></h5>
                                    <?php
                                    $string = strip_tags($hosting['meta_description']);
                                ...
                                <td style="font-size: 11px; padding: 15px;">
                                    ...
                                    <span onclick="showcommentbox('<?php echo $hosting['id']; ?>')" data-toggle="modal" data-target="#bannercommentmodal">
                                    ...
                                    <?php $hosting['id']; if (in_array($hosting['id'], $favresource)) {  ?>
                                    ...
                                    <?php } else { ?>
                                        <span><a href="<?php echo base_url() ?>makefavoritesresource/<?php echo $hosting['id']; ?>/22"><img data-toggle="tooltip" data-placement="bottom" title="Favorites" style="width: 16px; margin-left: 8px; margin-right: 8px;" src="<?php echo base_url() ?>assets/icon/favorites.png" style="color:red;width: 16px;">Add To Favorites </a></span>
                                    <?php } ?>
                                    <span><a href="<?php echo $hosting['url']; ?>" target="_blank"><img data-toggle="tooltip" data-placement="bottom" title="View" src="<?php echo base_url() ?>assets/icon/whois.png" style="color:#3079C8; width: 16px;">View </a></span>
                                </td>
