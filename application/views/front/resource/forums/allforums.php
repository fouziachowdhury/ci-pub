            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="">
                    ...
                    <div class="showbandiv" id="postList">
                        <?php $this->load->view('front/resource/forums/forumsShowDiv'); ?>
                    </div>
                </div><!--/span-->
            </div><!--/span-->
        </div>
...
function searchFilter(page_num) {
    ...
    var table = 'forums';
    var page_link = 'front/resource/forums/forumsShowDiv';
...
<script>
    $(function () {
        $("#banTag").autocomplete({
            source: "<?php echo base_url() ?>resource/forumsTagAutocomplete",
