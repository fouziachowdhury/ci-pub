...
<section class="about-text ptb-100">
    <section class="section-title">
        <div class="container">
            <h3>You are choosing the Whois Platinum Package</h3>
            <h4>And Total Price is : $ <?php echo $amount; ?></h4>
        </div>
        <div class="container text-left">
            <h3><i class="fa fa-money" aria-hidden="true"></i> Pay WHois Platinum Package Fee with.... </h3>
        </div>
    </section>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 col-xs-4 col-sm-4">
                <form id="stripeA" action="<?php echo base_url() ?>paymentwithstripe" method="POST">
                    <input type="hidden" name="plan_name" value="Whois Platnium">
                    <input type="hidden" name="plan_id" value="whois-platinum-monthly">
