...
<section class="about-text ptb-100">
    <section class="section-title">
        <div class="container">
            <h3>You are choosing the Whois Gold Package</h3>
            <h4>And Total Price is : $ <?php echo $amount; ?></h4>
        </div>
        <div class="container text-left">
            <h3><i class="fa fa-money" aria-hidden="true"></i> Pay WHois Gold Package Fee with.... </h3>
        </div>
    </section>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 col-xs-4 col-sm-4">
                <form id="stripeA" action="<?php echo base_url() ?>paymentwithstripe" method="POST">
                    <input type="hidden" name="plan_name" value="Whois Gold">
                    <input type="hidden" name="plan_id" value="whois-gold-monthly">
