            ...
            <nav class="navbar m-menu navbar-default navbar-fixed-top">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <div style="float: left; height: 50px; padding: 15px 15px; font-size: 18px; line-height: 20px; background-color: transparent;"><a style="color: #fff;" class="navbar-brand" href="index.html"><i class="fa fa-times" aria-hidden="true"></i> PUBLYFE</a></div>
                    </div>
