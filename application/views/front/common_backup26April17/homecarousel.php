<div id="x-corp-carousel" class="carousel slide hero-slide hidden-xs" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <img src="<?php echo base_url() ?>/assets/front/images/template/hero-slide-1.jpg" alt="Hero Slide">
                    ...
                    <div class="item">
                        <img src="<?php echo base_url() ?>/assets/front/images/template/hero-slide-2.jpg" alt="...">
                    ...
                    <div class="item">
                        <img src="<?php echo base_url() ?>/assets/front/images/template/hero-slide-3.jpg" alt="...">
