                        ...
                        <ul class="list-unstyled list-inline" style="text-align: left;">
                            ...
                            <li>
                             ...
                             <li>
                                ...
                                <!--            <li><a onclick="searchbymyfavfb(<?php echo $_SESSION['member_id']; ?>)">My Favorites</a></li>-->
                                <!--            <li><a onclick="searchbymycomfb(<?php echo $_SESSION['member_id']; ?>)">My Comments</a></li>-->
                                <!--    </ul>-->
                                <!--</div>-->
                            </li>
                             ...
                             <button onclick="fbsearch()" style="margin-left: 5px; height: 24px; padding-top: 2px; padding-bottom: 0px;" class="btn btn-info">Search</button>
                        </ul>
                    </div>
<!--                    <div class="col-lg-4 col-md-5 col-sm-5 col-xs-12">
                        <div id="myTable_filter" class="dataTables_filter"><label>Tags:</label><input class="" placeholder="" aria-controls="myTable" type="text" id="banTag"><button onclick="fbsearch()" style="margin-left: 5px; height: 24px; padding-top: 2px; padding-bottom: 0px;" class="btn btn-info">Search</button></div>
                    </div>-->
                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
                        <div class="dataTables_length" id="myTable_length" style="float: right;">
                            <form method="get" id="dropdownlandsearch" name="dropdownlandsearch">
                                <label>Show 
                                    <select name="myTable_length" aria-controls="myTable" class="" id="fbdrop">
