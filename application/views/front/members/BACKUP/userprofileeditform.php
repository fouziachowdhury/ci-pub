            ...
            <div class="white-box">
                ...
                <form id="profile_edit" role="form" name="profile_edit" action="<?php echo base_url() ?>updateprofile/<?php echo $this->uri->segment('2'); ?>" method="post">
                    <div class="row">
                        ...
                        <?php }
                        ?>
                        <div class="col-md-6" style="border: 1px solid #ddd; background: #fff; width: 522px; margin-right: 10px;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="selectpicker form-control" name="country_id">
                                            <?php foreach ($country_info as $country) { ?>
                                                ...
                                                if ($country['country_id'] == $memberinfo->country_id) {
                                                    echo "selected";
                                                }
                        ...
                        <div class="col-md-6" style="border: 1px solid #ddd; height: 335px; width: 505px;">
