                        ...
                        <ul class="list-unstyled list-inline" style="text-align: left;">
                            ...
                            <li>
                             ...
                             <li>
                                ...
                                <!--        <li><a onclick="searchbymyfavppv(<?php echo $_SESSION['member_id']; ?>)">My Favorites</a></li>-->
                                <!--        <li><a onclick="searchbymycomppv(<?php echo $_SESSION['member_id']; ?>)">My Comments</a></li>-->
                                <!--    </ul>-->
                                <!--</div>-->
                            </li>
                             ...
                             <button onclick="ppv_search()" style="margin-left: 5px; height: 24px; padding-top: 2px; padding-bottom: 0px;" class="btn btn-info">Search</button>
                        </ul>
                    </div>
<!--                    <div class="col-lg-4 col-md-5 col-sm-5 col-xs-12">
                        <div id="myTable_filter" class="dataTables_filter"><label>Tags:</label>
                            ...
                            <button onclick="ppvsearch()" style="margin-left: 5px; height: 24px; padding-top: 2px; padding-bottom: 0px;" class="btn btn-info">Search</button>
                        </div>
                    </div>-->
