...
<!--                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <div id="myTable_filter" class="dataTables_filter"><label>Tags:<input class="" placeholder="" aria-controls="myTable" type="text" id="offerTag"></label></div>
                    </div>-->
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <div class="dataTables_length" id="myTable_length" style="float: right;">
                            <form method="get" id="dropdownlandsearch" name="dropdownlandsearch">
                                <label>Show <select name="myTable_length" aria-controls="myTable" class="" id="offerdrop">
