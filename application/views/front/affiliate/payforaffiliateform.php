...
<section class="about-text ptb-100">
    <section class="section-title">
        <div class="container">
            ...
            <ol>
                <?php $amount = 0; if(isset($option_id)){
                    foreach ($optionname as $rrr) {
                    $amount = $amount + $rrr['option_price'];
                    ?>
            ...
            <div class="col-md-4 col-xs-4 col-sm-4">
                <form action="<?php echo $paypal_settings[0]['paypal_action'];?>" method="post">
                   ...
                   <?php foreach ($optionname as $rrr) { ?>
                    <input type="hidden" name="item_name[]" value="<?php echo $rrr['option_id']; ?>">
                    <input type="hidden" name="amount[]" value="<?php echo $rrr['option_price']; ?>">
                    <?php }?>
                    ...
                    <input type="hidden" name="custom" value="<?php echo $custom; ?>/<?php echo $package_id; ?>/<?php foreach ($optionname as $rrr) { echo $rrr['option_id'].'/'; }?>">
                    
                    <!--<input type="hidden" name="optionid" value="<?php echo $option_id; ?>">-->
            ...
            <div class="col-md-4 col-xs-4 col-sm-4">
                <form id="stripeA" action="<?php echo base_url() ?>paymentwithstripe" method="POST">
                    ...
                    <script
                        ...
                        data-key="<?php echo $stripe_settings[0]['public_key'];?>"
